...
**MediaQuery:**
  ...
  matematica: {
    "Análise Combinatória": {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "[!IMPORTANT]\nQuando o enunciado pede **pelo menos 3 mulheres**, o caminho mais seguro é separar em casos mutuamente exclusivos e somar os resultados ao final.\n\n1. Caso 1: escolher 3 mulheres entre 6 e 2 homens entre 4.\n\n```formula\nC(6,3) × C(4,2) = 20 × 6 = 120\n```\n\n2. Caso 2: escolher 4 mulheres entre 6 e 1 homem entre 4.\n\n```formula\nC(6,4) × C(4,1) = 15 × 4 = 60\n```\n\n3. Caso 3: escolher 5 mulheres entre 6 e nenhum homem entre 4.\n\n```formula\nC(6,5) × C(4,0) = 6 × 1 = 6\n```\n\n[!RESULT]\nTotal de comissões = 120 + 60 + 6 = 186 maneiras.\n\n[!TIP]\nCombinação é usada quando a ordem dos escolhidos não altera o grupo formado. Se a ordem importasse, o modelo seria outro.",
        },
        {
    ...
    "Equações e Inequações": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nPara usar a propriedade **|A| < B ⟺ -B < A < B**, primeiro é obrigatório garantir que **B > 0**.\n\n```geometry\ntype: number-line\ntitle: Intervalo solução da inequação\nstartLabel: -1\nendLabel: 9\nintervalLabel: S = (-1, 9)\nnote: A condição x > -6 também aparece no processo, mas já fica satisfeita quando obtemos x > -1.\n```\n\n1. Verificar a condição do lado direito.\n\n```formula\nx + 6 > 0\nx > -6\n```\n\n2. Aplicar a propriedade do módulo.\n\n```formula\n|2x - 3| < x + 6\n-(x + 6) < 2x - 3 < x + 6\n```\n\n3. Resolver cada inequação.\n\n```formula\n-x - 6 < 2x - 3\n-3 < 3x\nx > -1\n\n2x - 3 < x + 6\nx < 9\n```\n\n[!RESULT]\nA interseção das condições é **-1 < x < 9**, ou seja, **S = (-1, 9)**.\n\n[!TIP]\nEm inequações modulares, a resposta final vem da interseção de todas as restrições, e não de apenas uma delas.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Estatística e Probabilidade": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nComo a retirada é feita **sem reposição**, o segundo evento depende do primeiro. Isso transforma o problema em probabilidade condicional.\n\n1. Probabilidade de a primeira bola ser vermelha.\n\n```formula\nP(A) = 5/8\n```\n\n2. Probabilidade de a segunda bola ser azul, dado que a primeira foi vermelha.\n\n```formula\nP(B|A) = 3/7\n```\n\n3. Aplicar a regra do produto para eventos dependentes.\n\n```formula\nP(A ∩ B) = P(A) × P(B|A)\nP(A ∩ B) = 5/8 × 3/7 = 15/56\n```\n\n[!RESULT]\nA probabilidade pedida é **15/56 ≈ 0,268**, ou aproximadamente **26,8%**.\n\n[!TIP]\nQuando aparece a expressão **sem reposição**, espere que o denominador mude entre uma etapa e outra.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    Funções: {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nComo o coeficiente a = -5 é negativo, a parábola tem concavidade voltada para baixo. Isso significa que o vértice representa um ponto de máximo.\n\n```geometry\ntype: parabola\ntitle: Esboço da trajetória da função h(t)\naxisXLabel: t\naxisYLabel: h\npointLabel: Vértice\nnote: O vértice marca a altura máxima; a raiz positiva indica quando o projétil volta ao solo.\n```\n\n1. Encontrar o tempo do vértice.\n\n```formula\ntv = -b / (2a)\ntv = -40 / (2 × -5)\ntv = 4 s\n```\n\n2. Calcular a altura máxima.\n\n```formula\nh(4) = -5 × 4² + 40 × 4 + 45\nh(4) = -80 + 160 + 45\nh(4) = 125 m\n```\n\n[!RESULT]\nAltura máxima = 125 m, atingida em t = 4 s.\n\n3. Descobrir quando o projétil atinge o solo.\n\n```formula\nh(t) = 0\n-5t² + 40t + 45 = 0\nt² - 8t - 9 = 0\nΔ = (-8)² - 4 × 1 × (-9) = 100\nt = (8 ± 10) / 2\nt₁ = 9\nt₂ = -1\n```\n\n[!TIP]\nEm problemas físicos com tempo, descarte raízes negativas quando elas não fizerem sentido no contexto.\n\n[!RESULT]\nO projétil atinge o solo em t = 9 s.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Geometria Plana": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nEm triângulo retângulo, a hipotenusa é sempre o lado oposto ao ângulo de 90° e também o maior lado da figura.\n\n```geometry\ntype: right-triangle\ntitle: Triângulo retângulo do problema\nvertexLeftLabel: A\nvertexTopLabel: C\nvertexRightLabel: B\nbaseLabel: 5 cm\nheightLabel: 12 cm\nhypotenuseLabel: 13 cm\nnote: A altura relativa à hipotenusa foi indicada pela linha tracejada interna.\n```\n\n1. Encontrar o outro cateto usando Pitágoras.\n\n```formula\na² = b² + c²\n13² = 5² + c²\n169 = 25 + c²\nc² = 144\nc = 12 cm\n```\n\n[!RESULT]\nCateto desconhecido: c = 12 cm.\n\n2. Calcular a área usando os catetos como base e altura.\n\n```formula\nA = (b × c) / 2\nA = (5 × 12) / 2\nA = 30 cm²\n```\n\n[!TIP]\nNo triângulo retângulo, os catetos são perpendiculares, então eles podem ser usados diretamente no cálculo da área.\n\n3. Encontrar a altura relativa à hipotenusa.\n\n```formula\nA = (a × h) / 2\n30 = (13 × h) / 2\n60 = 13h\nh = 60/13 ≈ 4,62 cm\n```\n\n[!EXAMPLE]\nA mesma resposta aparece pela relação métrica b × c = a × h:\n5 × 12 = 13 × h.\n\n[!RESULT]\nAltura relativa à hipotenusa: h = 60/13 cm ≈ 4,62 cm.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Geometria Espacial": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nSe você fizer um corte vertical no cone reto, aparece um triângulo retângulo formado por raio, altura e geratriz.\n\n```geometry\ntype: cone-section\ntitle: Corte vertical do cone\nvertexTopLabel: V\nbaseLabel: r = 6 cm\nheightLabel: h = 8 cm\nhypotenuseLabel: g = 10 cm\nnote: O corte do cone gera o triângulo usado nas contas de geratriz e área lateral.\n```\n\n1. Encontrar a geratriz com Pitágoras.\n\n```formula\ng² = r² + h²\ng² = 6² + 8²\ng² = 36 + 64\ng² = 100\ng = 10 cm\n```\n\n[!RESULT]\nGeratriz do cone: g = 10 cm.\n\n2. Calcular a área lateral.\n\n```formula\nAL = π × r × g\nAL = π × 6 × 10\nAL = 60π cm²\nAL ≈ 188,4 cm²\n```\n\n[!TIP]\nA área lateral do cone representa a superfície curva aberta, que vira um setor circular quando planificada.\n\n3. Calcular o volume do cone.\n\n```formula\nV = (1/3) × π × r² × h\nV = (1/3) × π × 6² × 8\nV = (1/3) × 288π\nV = 96π cm³\nV ≈ 301,44 cm³\n```\n\n[!RESULT]\nVolume do cone: 96π cm³ ≈ 301,44 cm³.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Juros Simples e Compostos": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nJuros simples crescem de forma **linear**; juros compostos crescem de forma **acumulada**, porque cada período incide sobre o montante do período anterior.\n\n1. Montante em juros simples.\n\n```formula\nM = C × (1 + i × t)\nM = 10.000 × (1 + 0,02 × 12)\nM = 10.000 × 1,24\nM = R$ 12.400,00\n```\n\n2. Montante em juros compostos.\n\n```formula\nM = C × (1 + i)^t\nM = 10.000 × (1,02)^12\nM ≈ 10.000 × 1,268242\nM ≈ R$ 12.682,42\n```\n\n3. Comparar os resultados.\n\n```formula\nDiferença = 12.682,42 - 12.400,00 = R$ 282,42\n```\n\n[!RESULT]\nApós 12 meses, os juros compostos rendem **R$ 282,42** a mais que os juros simples.\n\n[!TIP]\nEm porcentagens sucessivas no tempo, evite somar valores manualmente quando existe uma fórmula de montante pronta para o regime pedido.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    Trigonometria: {
      title: "Trigonometria",
      introduction:
        "Trigonometria estuda as relações entre ângulos e lados dos triângulos, principalmente do triângulo retângulo. As três razões fundamentais são seno, cosseno e tangente. Elas aparecem em geometria, física, engenharia e análise de gráficos periódicos.",
      sections: [
        {
          heading: "📋 PROBLEMA",
          content:
            "Em um triângulo retângulo, em relação ao ângulo θ, o cateto oposto mede 6 cm e o cateto adjacente mede 8 cm. Determine: a) a hipotenusa, b) sen θ, c) cos θ e d) tan θ.",
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nAs razões trigonométricas sempre dependem do ângulo de referência. Antes de aplicar as fórmulas, identifique quem é o cateto oposto e quem é o adjacente em relação a θ.\n\n```geometry\ntype: right-triangle\ntitle: Triângulo de referência para o ângulo θ\nvertexLeftLabel: A\nvertexTopLabel: C\nvertexRightLabel: B\nbaseLabel: 8 cm\nheightLabel: 6 cm\nhypotenuseLabel: 10 cm\nangleLabel: θ\nnote: Em relação a θ, o lado vertical é o cateto oposto e a base é o cateto adjacente.\n```\n\n1. Calcular a hipotenusa pelo Teorema de Pitágoras.\n\n```formula\nh² = 6² + 8²\nh² = 36 + 64\nh² = 100\nh = 10 cm\n```\n\n[!RESULT]\nHipotenusa = 10 cm.\n\n2. Aplicar as razões trigonométricas em relação ao ângulo θ.\n\n```formula\nsen θ = cateto oposto / hipotenusa = 6/10 = 3/5 = 0,6\ncos θ = cateto adjacente / hipotenusa = 8/10 = 4/5 = 0,8\ntan θ = cateto oposto / cateto adjacente = 6/8 = 3/4 = 0,75\n```\n\n[!TIP]\nSeno relaciona oposto e hipotenusa; cosseno relaciona adjacente e hipotenusa; tangente compara diretamente oposto e adjacente.\n\n[!RESULT]\nsen θ = 0,6\ncos θ = 0,8\ntan θ = 0,75",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
            "• sen θ = cateto oposto / hipotenusa\n• cos θ = cateto adjacente / hipotenusa\n• tan θ = cateto oposto / cateto adjacente\n• Pitágoras ajuda a encontrar lados faltantes antes das razões trigonométricas",
        },
      ],
      keyTopics: [
    ...
    "Lógica Matemática": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nA contrapositiva de **p → q** é **¬q → ¬p**, e as duas proposições são logicamente equivalentes. A tabela-verdade serve para demonstrar isso linha por linha.\n\n1. Montar as linhas básicas com os valores de **p** e **q**.\n\n```formula\n(V, V), (V, F), (F, V), (F, F)\n```\n\n2. Calcular as colunas intermediárias.\n\n```formula\np → q = V, F, V, V\n¬q → ¬p = V, F, V, V\n```\n\n3. Comparar as duas colunas com a bicondicional.\n\n```formula\n(p → q) ↔ (¬q → ¬p) = V, V, V, V\n```\n\n[!RESULT]\nA proposição é uma **tautologia**, portanto **(p → q) ↔ (¬q → ¬p)** é sempre verdadeira.\n\n[!TIP]\nNo condicional, o único caso falso é quando o antecedente é verdadeiro e o consequente é falso. Esse detalhe evita a maior parte dos erros em tabela-verdade.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Matrizes e Determinantes": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nA Regra de Sarrus vale apenas para matrizes **3×3**. O primeiro passo é repetir as duas primeiras colunas à direita.\n\n```geometry\ntype: sarrus-grid\ntitle: Preparação da Regra de Sarrus\nrow1: 2, 1, 3, 2, 1\nrow2: 4, -1, 2, 4, -1\nrow3: 1, 0, 1, 1, 0\nnote: As diagonais verdes correspondem à soma principal; as amarelas correspondem à soma secundária, que será subtraída.\n```\n\n1. Somar as diagonais principais.\n\n```formula\nD1 = 2 × (-1) × 1 = -2\nD2 = 1 × 2 × 1 = 2\nD3 = 3 × 4 × 0 = 0\nSoma principal = 0\n```\n\n2. Somar as diagonais secundárias.\n\n```formula\nD4 = 1 × 2 × 1 = 2\nD5 = 2 × 4 × 1 = 8\nD6 = 3 × (-1) × 0 = 0\nSoma secundária = 10\n```\n\n3. Fazer a diferença.\n\n```formula\ndet(A) = 0 - 10 = -10\n```\n\n[!RESULT]\nO determinante da matriz é **-10**, logo **A é inversível**.\n\n[!TIP]\nSe o determinante fosse zero, a matriz seria singular e não teria inversa.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Porcentagem e Regra de Três": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nVariações percentuais sucessivas são resolvidas por **fatores multiplicativos**. Não faz sentido somar **+25%** e **-20%** como se ambos atuassem sobre a mesma base.\n\n1. Aplicar o aumento de 25%.\n\n```formula\nFator de aumento = 1 + 25/100 = 1,25\nPreço₁ = 80 × 1,25 = R$ 100,00\n```\n\n2. Aplicar o desconto de 20% sobre o novo preço.\n\n```formula\nFator de desconto = 1 - 20/100 = 0,80\nPreço final = 100 × 0,80 = R$ 80,00\n```\n\n3. Conferir pelo fator acumulado.\n\n```formula\nFator total = 1,25 × 0,80 = 1,00\nPreço final = 80 × 1,00 = R$ 80,00\n```\n\n[!RESULT]\nO preço final é **R$ 80,00**, exatamente igual ao preço original.\n\n[!TIP]\nA base mudou entre as duas etapas. Por isso, **+25%** seguido de **-20%** não representa um saldo de **+5%**.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Progressões (PA e PG)": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nAs alturas dos rebotes formam uma **PG decrescente** com razão **q = 3/4**, porque cada nova altura é 75% da anterior.\n\n```geometry\ntype: bounce-sequence\ntitle: Sequência das alturas dos rebotes\nlevelOneLabel: 16 m\nlevelTwoLabel: 12 m\nlevelThreeLabel: 9 m\nlevelFourLabel: 6,75 m\nnote: Cada barra representa a altura máxima atingida após um rebote sucessivo.\n```\n\n1. Encontrar a altura após o 4º rebote.\n\n```formula\na₄ = a₁ × q^(4-1)\na₄ = 16 × (3/4)³\na₄ = 16 × 27/64\na₄ = 6,75 m\n```\n\n2. Somar a distância dos rebotes.\n\n```formula\nS = a₁ / (1 - q)\nS = 12 / (1 - 3/4)\nS = 12 / (1/4) = 48 m\n```\n\n3. Considerar subida e descida em cada rebote.\n\n```formula\nD = 16 + 2 × 48\nD = 112 m\n```\n\n[!RESULT]\nA altura no 4º rebote é **6,75 m** e a distância total percorrida tende a **112 m**.\n\n[!TIP]\nNa soma infinita, a queda inicial entra apenas uma vez; os rebotes entram em dobro porque a bola sobe e depois desce.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
    ...
    "Razão e Proporção": {
      ...
      sections: [
        ...
        },
        {
          heading: "📝 RESOLUÇÃO PASSO A PASSO",
          content:
            "[!IMPORTANT]\nEm divisão diretamente proporcional, cada pessoa recebe uma quantidade proporcional ao peso que aparece na razão.\n\n1. Definir a constante de proporcionalidade.\n\n```formula\n2k + 3k + 5k = 180.000\n10k = 180.000\nk = 18.000\n```\n\n2. Calcular a parte de cada irmão.\n\n```formula\nAna = 2k = 2 × 18.000 = R$ 36.000,00\nBruno = 3k = 3 × 18.000 = R$ 54.000,00\nCarlos = 5k = 5 × 18.000 = R$ 90.000,00\n```\n\n3. Verificar a soma final.\n\n```formula\n36.000 + 54.000 + 90.000 = 180.000\n```\n\n[!RESULT]\nAna recebe **R$ 36.000,00**, Bruno recebe **R$ 54.000,00** e Carlos recebe **R$ 90.000,00**.\n\n[!TIP]\nOutra leitura útil é por frações: Ana fica com **2/10**, Bruno com **3/10** e Carlos com **5/10** do total.",
        },
        {
          heading: "💡 CONCEITOS APLICADOS",
          content:
